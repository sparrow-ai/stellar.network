          ...
          return 1 + 0.5*count_in_links(d);
            ...
            if (!!d.ledger) {
                ...
                this_select
                  ...
                  .attr('dy', function(d,i) {return 3.5*mult + i*mult + 'em';})
                  .attr('fill', 'white')
                  .text(function (d) {
                      return d;
                  });
...
*/
  ...
  function tick() {
    ...
    //desc.setAttribute("id","network-description");
    //desc.appendChild(document.createTextNode(description));
    //document.getElementById("graph").appendChild(desc);
    });
