...
class StellarNetwork(object):
    ...
    def __init__(self):
        ...
        with open("/home/sobolosrios/stellar-run/stellar-core.cfg","r") as fh:
    ...
    def update_all_statistics(self):
        with open("/home/sobolosrios/quorum_view/networkdata/agree_stats.json","w") as fh:
            agreed_stats = self.network_statistics(self.agree_graph) 
            fh.write(json.dumps(agreed_stats))
        with open("/home/sobolosrios/quorum_view/networkdata/disagree_stats.json","w") as fh:
            disagreed_stats = self.network_statistics(self.disagree_graph) 
            fh.write(json.dumps(disagreed_stats))

        with open("/home/sobolosrios/quorum_view/networkdata/fail_with_stats.json","w") as fh:
            fail_with_stats = self.network_statistics(self.fail_with_graph) 
            fh.write(json.dumps(fail_with_stats))
        with open("/home/sobolosrios/quorum_view/networkdata/missing_stats.json","w") as fh:
...
if __name__ == '__main__':
    ...
    #s.update_nodes()
    s.update_all()
    pp.pprint(s.get_quorum("sparrow_tw"))
    ...
    s.export_json(s.fail_with_graph, "/home/sobolosrios/quorum_view/networkdata/fail_with.json")
    s.export_json(s.disagree_graph, "/home/sobolosrios/quorum_view/networkdata/disagree.json")
    s.export_json(s.agree_graph, "/home/sobolosrios/quorum_view/networkdata/agree.json")
    s.export_json(s.missing_graph, "/home/sobolosrios/quorum_view/networkdata/missing.json")
